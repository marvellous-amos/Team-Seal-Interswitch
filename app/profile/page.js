  ...
  return (
    <div className="min-h-screen bg-bg-base px-4 pt-6 pb-24">
      ...
      <div className="max-w-md mx-auto space-y-4">
        ...
        {/* NEW: Secondary Leaderboard Button for better visibility */}
        <motion.button
          whileTap={{ scale: 0.98 }}
          onClick={() => router.push("/leaderboard")}
          className="btn-neutral w-full py-4 text-sm font-black border-2 border-ink-300 flex items-center justify-center gap-3"
        >
          <Trophy size={18} className="text-gold" /> VIEW GLOBAL RANKINGS
        </motion.button>
